    ...
    uiCallbacks.b = function(which) {
        ...
        if (which == 0) {
           if (!window.fblogin) { 
              ...
              FB.ui({
                    method: 'apprequests',
                    message: 'I challenge you to a quick conflict. I was hesitant to engage you at first, but I know you will rise up to the challenge.'
                 }, function(response){
...
// ==========================================================
// This part of the code deals with Facebook stuff.
// ==========================================================
